...
# We only want up to the start of MainWindow's content.
# Let's find "    callback remove_sync_folder(string /*id*/);"
idx = top.find("    callback remove_sync_folder(string /*id*/);")
if idx == -1:
    print("Could not find remove_sync_folder callback!")
    sys.exit(1)

top = top[:idx + len("    callback remove_sync_folder(string /*id*/);\n\n")]
